...
train_df = pd.read_json(open("D:/input/train.json", "r"))
test_df = pd.read_json(open("D:/input/test.json", "r"))
...
print("NN-CV: {}".format(log_loss(y_train, nn_oof_train)))
...
x_train = np.concatenate((xg_oof_train, et_oof_train, rf_oof_train,nn_oof_train), axis=1)
x_test = np.concatenate((xg_oof_test, et_oof_test, rf_oof_test,nn_oof_test), axis=1)
